...
extern boolean walk_path(coord *, coord *, boolean (*)(void *,int,int), boolean (*)(void *,int,int), void *);
...
extern void perform_widegaze_attacks(void);
extern void perform_cloudface_widegaze(void);
