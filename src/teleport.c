...
boolean
eofflin(coord *cc, register xchar xx, register xchar yy, struct permonst *mdat)
{
...
boolean
eofflin_close(coord *cc, register xchar xx, register xchar yy, struct permonst *mdat)
{
#define COORD_SIZE	8
...
boolean
eonline(coord *cc, register xchar xx, register xchar yy, struct permonst *mdat)
{
...
rloc_pos_ok(
	register int x,
	register int y,		/* coordinates of candidate location */
	struct monst *mtmp)
{
	register int xx, yy;
...
void
randomly_place_obj(struct obj *obj)
{
	xchar tx, ty, otx, oty;
