...
{	{"Illithanachronounbinder", 		 0}, {
	...
	SA_HUMAN|SA_DWARF|SA_GNOME|SA_ELF|SA_ORC|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_SALAMANDER|SA_ENT|SA_YUKI_ONNA|SA_CLOCKWORK|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  12, 10,  7, 12,  12,  7 },
	{  24, 20, 15, 20, 24, 15 },
