...
{	{"Barbarian", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ORC|SA_VAMPIRE|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_CENTAUR|SA_SALAMANDER|SA_ETHEREALOID|SA_ENT|SA_LEPRECHAUN|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  16,  7,  7, 15, 16,  6 },
	{  30,  6,  7, 20, 30,  7 },
...
{	{"Binder", 		 0}, {
	...
	ART_PEN_OF_THE_VOID,
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_DWARF|SA_GNOME|SA_ELF|SA_ORC|SA_CLOCKWORK|SA_VAMPIRE|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_YUKI_ONNA|SA_FORMIAN|SA_DRIDER|SA_CENTAUR|SA_SILVERMAN|SA_SALAMANDER|SA_ETHEREALOID|SA_ENT|SA_LEPRECHAUN|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
...
{	{"Convict", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_DWARF|SA_GNOME|SA_ORC|SA_ELF|SA_VAMPIRE|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_YUKI_ONNA|SA_DRIDER|SA_SALAMANDER|SA_LEPRECHAUN|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7, 13,  6 },
	{  20, 20, 10, 20, 20, 10 },
...
{	{"Illithanachronounbinder", 		 0}, {
	...
	SA_HUMAN|SA_DWARF|SA_GNOME|SA_ELF|SA_ORC|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_SALAMANDER|SA_ENT|SA_YUKI_ONNA|SA_TIEFLING|SA_AASIMAR|SA_FORMIAN|SA_DRIDER|SA_CENTAUR|SA_CLOCKWORK|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  12, 10,  7, 12,  12,  7 },
	{  24, 20, 15, 20, 24, 15 },
...
{	{"Monk", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_CLOCKWORK|SA_CHIROPTERAN|SA_HALF_DRAGON|SA_YUKI_ONNA|SA_ETHEREALOID|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  8,  8,  7,  7 },
	{  25, 10, 20, 20, 15, 10 },
...
{	{"Pirate", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF|SA_LEPRECHAUN|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
...
{	{"Rogue", 0}, {
	...
	SA_HUMAN|SA_ORC|SA_VAMPIRE|SA_ELF|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_SILVERMAN|SA_SALAMANDER|SA_LEPRECHAUN|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  7,  6 },
	{  20, 10, 10, 30, 20, 10 },
...
{	{"Tourist", 0}, {
	...
	SA_HUMAN|SA_ETHEREALOID|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  6,  7,  7, 10 },
	{  15, 10, 10, 15, 30, 20 },
	/* Init   Lower  Higher */
...
{	{"Wizard", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF|SA_GNOME|SA_ORC|SA_VAMPIRE|SA_HALF_DRAGON|SA_SALAMANDER|SA_ETHEREALOID|SA_ENT|SA_LEPRECHAUN|SA_OCTOPODE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  7,  7,  7,  7 },
	{  10, 30, 10, 20, 20, 10 },
...
{	"Octopode", "octopodic", "octopode-kind", "Oct", 'O',
	{0, 0},
...
{	"parasitized android", "parasitized android", "parasitized android-kind", "And", 0,
...
give_ascension_trophy(void)
{
	...
	if(Race_if(PM_CLOCKWORK_AUTOMATON))
		...
		set_trophy(YUKI_ASC);
        else if(Race_if(PM_SALAMANDER) || Race_if(PM_ETHEREALOID) || Race_if(PM_ENT) || Race_if(PM_LEPRECHAUN) || Race_if(PM_OCTOPODE))
		achieve.new_races = 1;
