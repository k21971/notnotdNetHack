...
static int int_sqrt(int);
static boolean issemispacious(struct mkroom *);
static void mkshop(void);
static void mkzoo(int);
static void mkswamp(void);
static void mktemple(void);
static void mkkamereltowers(void);
static void mkminorspire(void);
static void mksentinelclearing(void);
static void mkfishingvillage(void);
static void mkpluhomestead(void);
static void mkpluroom(int);
static void mkelfhut(int, int, int, boolean);
static void mkruinedelfhut(int, int);
static void mkdrowshanty(int);
static void mkorccave(int);
static void mkshantyorcave(int, boolean, int);
static void mkwraithclearing(int);
static void mkstonepillars(void);
static void mkmordorfossil(int);
static void mklavapool(void);
static void mkwell(int);
static void mkfishinghut(int);
static void mkpluvillage(void);
static void mkferrufort(void);
static void mkferrutower(void);
static void mkferrubarracks(void);
static void mkinvertzigg(void);
static void mkmch(int);
...
static void mkvaultlolth(void);
static void mklolthgnoll(void);
static void mklolthgarden(void);
static void mklolthtroll(void);
static void mklolthtemple(void);
static void mklolthcell(void);
static void mklolthdown(void);
static void mklolthup(void);
static void mksgarden(void);
static void mkgarden(struct mkroom *);
static void mklibrary(struct mkroom *);
static void mkarmory(struct mkroom *);
static void mkisland(void);
static void mkriver(void);
static void mkneuriver(void);
static void mkforest12river(void);
static void mkneucell(int,int,struct obj *,int,int);
static void liquify(int,int,int);
static void neuliquify(int, int, int);
static void chaliquify(int, int, int);
static struct permonst * morguemon(void);
static struct permonst * antholemon(void);
static struct permonst * squadmon(struct d_level *);
...
static
void
mkruinedelfhut(int background, int foreground)
{
	int x,y,tries=0;
	int i,j, pathto = 0;
	boolean good=FALSE, okspot, accessible;
...
void
place_elfhaunt_forest_features(void)
{
...
void
place_haunted_forest_features(void)
{
	int i = 6 + d(2,6);
	// if(rn2(3))
