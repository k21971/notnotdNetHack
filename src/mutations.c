...
static void mutation_effects(int);
...
mutation_effects(int mutation)
{
	if(mutation == TT_INFRAVISION_1){
		...
		new_light_source(LS_MONSTER, (void *)&youmonst, uemit_light());
