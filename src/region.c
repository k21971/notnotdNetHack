...
save_regions(int fd, int mode)
{
	...
	bwrite(fd, (void *) &regions[i]->arg, sizeof (struct region_arg));
    }
	...
	boolean ghostly /* If a bones file restore */)
{
	...
	mread(fd, (void *) &regions[i]->arg, sizeof (struct region_arg));
    }
...
boolean
enter_force_field(void * p1, void * p2)
{
    struct monst *mtmp;
...
boolean
expire_generic_cloud(void * p1, void * p2)
{
    NhRegion *reg;
    int damage;
...
boolean
inside_generic_cloud(void * p1, void * p2)
{
    NhRegion *reg;
    struct monst *mdef;
    struct region_arg *cloud_data;
...
NhRegion *
create_generic_cloud(xchar x, xchar y, int radius, struct region_arg *cloud_data, boolean yours)
{
    NhRegion *cloud;
    int i, nrect;
    NhRect tmprect;
...
NhRegion *
create_gas_cloud(xchar x, xchar y, int radius, int damage, boolean yours)
{
    NhRegion *cloud;
    int i, nrect;
    NhRect tmprect;
...
boolean
expire_fog_cloud(void * p1, void * p2)
{
    return TRUE;		/* OK, it's gone, you can free it! */
}

boolean
inside_fog_cloud(void * p1, void * p2)
{
    return FALSE;		/* Monster is still alive */
}

NhRegion *
create_fog_cloud(xchar x, xchar y, int radius, int damage, boolean yours)
{
    NhRegion *cloud;
    int i, nrect;
    NhRect tmprect;
...
boolean
expire_dust_cloud(void * p1, void * p2)
{
    NhRegion *reg;
    int nx, ny;
    int damage;
...
boolean
inside_dust_cloud(void * p1, void * p2)
{
    NhRegion *reg;
    struct monst *mtmp;
    int damage;
...
NhRegion *
create_dust_cloud(xchar x, xchar y, int radius, int damage)
{
    NhRegion *cloud;
    int i, nrect;
    NhRect tmprect;
