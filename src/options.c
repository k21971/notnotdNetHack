...
int
value_of_name(const char *name, const struct name_value *name_values)
{
...
add_rgb_color_option(struct rgb_color_option *new_option, struct rgb_color_option *list_head)
{
    if (list_head == NULL)
		return new_option;
...
boolean
parse_monster_template(char *str)
{
