...
static int you_scent_callback(void *, int, int);
static void map_invisible_core(xchar, xchar, boolean);
...
static void
map_invisible_core(register xchar x, register xchar y, boolean new)
{
...
display_monster(
	register xchar x,
	register xchar y,		/* display position */
...
boolean
sense_by_scent(struct monst *mon)
{
 ...
 */
static int
swallow_to_glyph(int mtyp, int loc)
{
