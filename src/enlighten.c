...
static void spirits_enlightenment(boolean);
static void aasimar_enlightenment_subroutine(boolean);
static void mutations_enlightenment(boolean);
static void genocide_enlightenment(void);
static void research_enlightenment(void);
static void research_dump(void);
