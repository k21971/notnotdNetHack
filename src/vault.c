...
static boolean
clear_fcorr(register struct monst *grd, register boolean forceshow)
{
...
static void
restfakecorr(register struct monst *grd)
{
...
static boolean
in_fcorridor(register struct monst *grd, int x, int y)
{
	register int fci;
