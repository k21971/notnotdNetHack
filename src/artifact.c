...
static void artifact_protection(void);
...
static void pg_bullwhip_hit(struct monst *magr, struct monst *mdef, struct obj *);
...
void
add_omod_list(unsigned long int *omod_list, int omod)
{
	if (!omod)
		return;
...
void
copy_omod_list(struct obj *obj, unsigned long int *omod_list)
{
	int i;
...
static void
pg_bullwhip_hit(struct monst *magr, struct monst *mdef, struct obj *otmp)
{
	boolean youagr = (magr == &youmonst);
	boolean youdef = (mdef == &youmonst);
